...
This is an unofficial, fan-made tool and isn't affiliated with Digital Extremes or Warframe Market & Warframe Drop Data. It's a light API consumer - pricing pulls are rate-limited (2 req/sec) to not spam the Warframe Market API, at the cost of it taking a couple minutes.
